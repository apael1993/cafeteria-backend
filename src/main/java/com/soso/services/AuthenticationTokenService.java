...
public class AuthenticationTokenService {
    ...
    public static AuthenticationToken getGeneratedAuthenticationToken(@NotNull Integer serviceId, String phonenumber){
        AuthenticationToken authenticationToken =new AuthenticationToken(serviceId ,BaseSecurity.getMd5Version(BaseSecurity.getMd5Version(BaseSecurity.getMd5Version(LocalDateTime.now().toString())+BaseSecurity.getMd5Version(phonenumber) + serviceId.toString())));
